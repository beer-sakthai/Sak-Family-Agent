...
- `references/portfolio-stances.md` — two contrasting portfolio design stances (Calm Editorial / Dark Studio), including color palettes, layout choices, interaction patterns, and guidance on when to use each. Load this when the user asks for a portfolio or landing-page sketch.
