...
description: This skill should be used when the user asks to add MCP App support to my web app,
  turn my web app into a hybrid MCP App, make my web page work as an MCP App too,
  wrap my existing UI as an MCP App, convert iframe embed to MCP App, turn my SPA
  into an
...
---
