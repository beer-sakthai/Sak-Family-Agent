---
name: SakSit-plan
description: Write actionable markdown plans for execution.
version: 2.0.0
...
metadata:
  hermes:
    ...
    - SakSit-test-driven-development
    - SakSit-requesting-code-review
...
**For multi-platform content workflows (Beer's common pattern):**
- After posting to Instagram → verify the API response status and post URL before cross-posting to LinkedIn
