...
**SakKing Agent** (`@sakking_agent_bot`), **SakSee** (`@saksee_agent_bot`), and **SakJules** (`@sakjules_agent_bot`);
we
...
do business or operations work — business strategy belongs to **SakKing**, and
running Beer's daily schedule and routines belongs to **SakTan**.
