...
description: Lightweight FastAPI + SQLite + uv backend patterns for internal business    tools
  u2014 lead trackers, webhook receivers, data APIs, admin dashboards. Beers    go-to
