...
description: >-
  ...
  family health state to Beer. Covers the Care-cycle audit of the fleet.
triggers:
  - why aren't my agents replying
  - check the family
  - family health check
  - are the siblings alive
  - why isn't X replying (where X is a sibling name)
  - sakthai not responding
  - saksee silent
  - saksit bot down
