...
license: MIT
description: >-
  Master Hugging Face Hub storage ecosystem — Git-based repo limits,
  Storage Buckets (S3-compatible mutable object storage), quota
  management, Xet dedup backend, and zero-cost patterns.
---
