...
- **Model cross-link tags**: Add `model:Nanthasit/repo-name` tags in YAML `tags:` list to cross-link datasets to models in HF search — creates discoverability loops between datasets and their sibling models (see references for detailed pattern)
