---
name: SakThai-hf-oauth-and-tokens
author: SakThai
license: MIT
description: >
  Complete reference on Hugging Face Hub authentication — User Access Tokens
  (fine-grained, read, write), OAuth 2.0 / OpenID Connect flows (authorization
  code, device code, PKCE), Spaces OAuth integration, Token Exchange for
  Organizations (RFC 8693), and Trusted Publishers (CI/CD OIDC keyless auth).
