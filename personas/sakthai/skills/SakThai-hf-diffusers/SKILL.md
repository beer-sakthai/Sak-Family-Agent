...
description: 'Hugging Face Diffusers: diffusion model library for image, video, and audio generation.
  Covers DiffusionPipeline, schedulers, memory optimizations, training examples, and
