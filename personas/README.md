...
Today, they collectively host **763 specialized skills** in their overlays
...
│   └── skills/         # Contains the 285 skills mapped to SakThai
├── sakking/            # Contains the 306 skills mapped to SakKing
├── saksit/             # Contains the 104 skills mapped to SakSit
├── sakjules/           # Contains the 25 skills mapped to SakJules
└── saksee/             # Contains the 43 skills mapped to SakSee
```
