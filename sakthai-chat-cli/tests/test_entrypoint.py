...
def test_main_guard_returns_none() -> None:
    """The __main__ guard must not raise an exception when main() returns."""
    # This covers the exit path (line 3->exit in coverage report).
    with patch("sakthai.cli.main") as mock_main:
