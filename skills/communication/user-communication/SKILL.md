...
- **Keep a personal error log.** Beer expects you to track how many times you got something wrong before landing on the correct answer. If asked "how many times did you get it wrong?", answer honestly: "Attempt 1: X, Attempt 2: Y, Attempt 3: Z (correct)." Do not make excuses for the wrong attempts — just state the facts.
