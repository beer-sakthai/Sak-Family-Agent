...
- **\"Show me first\"** — Before performing irreversible or bulk operations on repos/skills/settings that affect siblings or shared infrastructure, first SHOW the current state (list files, check status, diff). Let Beer confirm before acting. This is not asking permission for every step — it's verifying scope before mass changes.
