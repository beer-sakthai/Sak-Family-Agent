---
name: hf-bitsandbytes-quantization
author: SakThai
license: MIT
...
tags:
  ...
  - qlora
  - memory-optimization
trigger: when the user asks about memory-efficient inference, quantization, 4-bit, 8-bit, QLoRA, or loading large models on limited GPUs
---
