...
[`SOUL.md`](./docs/SOUL.md) for the full roster.
...
The House of Sak operates on a philosophical and operational state machine:

- **Dream** 💭: Conceptualizing the vision and intent.
- **Hope** ☀️: Defining goals and identifying the path forward.
- **Care** ❤️: Executing with precision and empathy.
- **Joy** ✨: Celebrating success and finding fulfillment.
- **Trust** 🤝: Building reliability and verifying outcomes.
- **Growth** 🌱: Learning from the cycle and evolving the memory.
