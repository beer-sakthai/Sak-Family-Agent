...
export const DANGEROUS_PATTERNS = [
  ...
  { pattern: /os\.system\s*\(|subprocess\.Popen\s*\(.*shell\s*=\s*True/i, reason: 'Unsanitized subshell execution in Python', severity: 'warning' as const },
  { pattern: /eval\s*\(|exec\s*\(/i, reason: 'Dynamic code execution (eval/exec)', severity: 'warning' as const },
  { pattern: /shutil\.rmtree\s*\(\s*["'](\/|~|\.)["']\s*\)/i, reason: 'Destructive directory tree removal', severity: 'dangerous' as const },
