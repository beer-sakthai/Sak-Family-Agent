...
export async function POST(req: NextRequest) {
  try {
    ...
    const config: LoraTrainingConfig = {
      ...
      modelName: body.modelName || 'sakthai-7b',
      datasetPath: body.datasetPath || '~/.sakthai/learning/dataset-staging/staging.jsonl',
      r: Number(body.r) || 16,
      ...
      targetModules: Array.isArray(body.targetModules) ? body.targetModules : ['q_proj', 'v_proj'],
      outputDir: body.outputDir || `checkpoints/${body.modelName || 'sakthai-7b'}_lora`,
    };
